...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Teleport : MonoBehaviour
    {
        ...
        //Dash stuff
        public Vector3 dashTo = Vector3.zero;
        ...
        void Update()
        {
            ...
            /*if (InteractionManager.Instance.moveType == InteractionManager.MovementType.DASH)
            {
                player.trackingOriginTransform.position = Vector3.Lerp(player.trackingOriginTransform.position, dashTo, Time.deltaTime * InteractionManager.Instance.movementSpeed * 10f);
            }*/
        }
        ...
        private void UpdatePointer()
        {
            ...
            if (teleportArc.DrawArc(out hitInfo))
            {
                ...
                hitWalkable = (hitInfo.collider.tag == "Walkable" || hitInfo.collider.tag == "Paint");

                if (Vector3.Dot(hitInfo.normal, Vector3.up) < 0.66f)//Don't allow player to walk on strong grades
                    hitWalkable = false;
            }
